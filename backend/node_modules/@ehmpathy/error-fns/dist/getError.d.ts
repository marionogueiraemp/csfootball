...
export declare class NoErrorThrownError extends HelpfulError {
    constructor();
}
/**
 ...
 */
export declare function getError<T = Error>(from: () => Promise<unknown>): Promise<T | NoErrorThrownError>;
export declare function getError<T = Error>(from: Promise<unknown>): Promise<T | NoErrorThrownError>;
export declare function getError<T = Error>(from: () => unknown): T | NoErrorThrownError;
