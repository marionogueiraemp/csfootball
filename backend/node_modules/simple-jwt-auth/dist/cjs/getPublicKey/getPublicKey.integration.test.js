...
describe('getPublicKey', () => {
    (0, test_fns_1.given)('the jwks uri needs to be discovered', () => {
        (0, test_fns_1.then)('it can discover public key from a reliable issuer (e.g., whodis.io)', () => __awaiter(void 0, void 0, void 0, function* () {
            const publicKey = yield (0, getPublicKey_1.getPublicKey)({ token });
            expect(publicKey).toContain('-----BEGIN PUBLIC KEY-----'); // sanity check
        }));
        (0, test_fns_1.then)('it can get the public key from cache the second time', () => __awaiter(void 0, void 0, void 0, function* () {
            // this test is not necessary, but doesnt hurt.
            const publicKey = yield (0, getPublicKey_1.getPublicKey)({ token });
            const publicKeyAgain = yield (0, getPublicKey_1.getPublicKey)({
                token,
            });
            expect(publicKeyAgain).toContain(publicKey); // sanity check
        }));
    });
    (0, test_fns_1.given)('the jwks uri is explicitly defined', () => {
        const jwksUri = 'https://oauth.whodis.io/32b8b554-12f5-4f9b-9f16-b13e0b532019/.well-known/jwks.json';
        (0, test_fns_1.then)(`it can extract the public key from a reliable issuer's jwksUri (e.g., whodis.io)`, () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=getPublicKey.integration.test.js.map