...
const verifyTokenSignatureMock = verifyTokenSignature_1.verifyTokenSignature;
describe('getSignedClaims', () => {
    describe('token signing algorithm', () => {
        it('should throw an error if user token specifies a symmetric signing algorithm - huge security risk otherwise since we lookup public key', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield (0, getSignedClaims_1.getSignedClaims)({ token, publicKey: '__PUBLIC_KEY__' });
    ...
    describe('token signature', () => {
        it('should verify the token signature', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=getSignedClaims.test.js.map