...
const getTokenFromAuthorizationCookie_1 = require("./getTokenFromAuthorizationCookie");
...
describe('getTokenFromAuthorizationCookie', () => {
    it('should return null if cookie header is not defined', () => {
        const headers = {};
        const token = (0, getTokenFromAuthorizationCookie_1.getTokenFromAuthorizationCookie)({ headers });
...
//# sourceMappingURL=getTokenFromAuthorizationCookie.test.js.map