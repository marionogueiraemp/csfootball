...
const importCrypto = () => {
    try {
        ...
        throw new Error('could not import crypto for isSignatureVerified. is this running in node.js?');
    }
};
exports.importCrypto = importCrypto;
//# sourceMappingURL=importCrypto.js.map