...
describe('getPublicKey', () => {
    given('the jwks uri needs to be discovered', () => {
        then('it can discover public key from a reliable issuer (e.g., whodis.io)', () => __awaiter(void 0, void 0, void 0, function* () {
            const publicKey = yield getPublicKey({ token });
            expect(publicKey).toContain('-----BEGIN PUBLIC KEY-----'); // sanity check
        }));
        then('it can get the public key from cache the second time', () => __awaiter(void 0, void 0, void 0, function* () {
            // this test is not necessary, but doesnt hurt.
            const publicKey = yield getPublicKey({ token });
            const publicKeyAgain = yield getPublicKey({
                token,
            });
    ...
    given('the jwks uri is explicitly defined', () => {
        ...
        then(`it can extract the public key from a reliable issuer's jwksUri (e.g., whodis.io)`, () => __awaiter(void 0, void 0, void 0, function* () {
            const publicKey = yield getPublicKey({ token, jwksUri });
            expect(publicKey).toContain('-----BEGIN PUBLIC KEY-----'); // sanity check
        }));
        then('it can get the public key from cache the second time', () => __awaiter(void 0, void 0, void 0, function* () {
            // this test is not necessary, but doesnt hurt.
