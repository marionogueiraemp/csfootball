...
describe('verifyTokenTimestamps', () => {
    it('should throw an error if no expiration is defined', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield verifyTokenTimestamps({ token });
    ...
    it('should not throw an error if token timestamps are valid', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=verifyTokenTimestamps.test.js.map