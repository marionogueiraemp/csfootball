    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('LEAGUE_MANAGER', 'League Manager'), ('NEWS_MANAGER', 'News Manager'), ('TEAM_OWNER', 'Team Owner'), ('PLAYER', 'Player')], default='PLAYER', max_length=20)),
